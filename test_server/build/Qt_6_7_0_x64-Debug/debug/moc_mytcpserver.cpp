...
Q_CONSTINIT static const uint qt_meta_data_CLASSEnumsENDCLASS[] = {
 ...
 // enum data: key, value
       2, uint(Enums::EnumTypeRequest::Form),
       3, uint(Enums::EnumTypeRequest::Approved),
       4, uint(Enums::EnumTypeRequest::Error),
...
Q_CONSTINIT const QMetaObject Enums::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSEnumsENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<Enums::EnumTypeRequest, std::true_type>,
        // Q_OBJECT / Q_GADGET
